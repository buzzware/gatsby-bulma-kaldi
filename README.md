...
Example Gatsby and Bulma CSS project, based on https://github.com/netlify-templates/gatsby-starter-netlify-cms

This project has :
* Gatsby 4
* Bulma
* Example "Kaldi" coffee content

It no longer has a CMS, Netlify or Forms
...
[![Netlify Status](https://api.netlify.com/api/v1/badges/b654c94e-08a6-4b79-b443-7837581b1d8d/deploy-status)](https://app.netlify.com/sites/gatsby-bulma-kaldi-ci/deploys)
...
<a href="https://app.netlify.com/start/deploy?repository=https://github.com/netlify-templates/gatsby-bulma-kaldi&amp;stack=cms"><img src="https://www.netlify.com/img/deploy/button.svg" alt="Deploy to Netlify"></a>
...
```
$ gatsby new [SITE_DIRECTORY_NAME] https://github.com/netlify-templates/gatsby-bulma-kaldi/
